...
$sendMessage[{description: $getVar[goodemoji] **Generado correctamente, revisa tus mensajes directos.**}{color:GREEN}{footer: Desarrollado por AdirModz👑#6666
};no]
...
$sendMessage[{description:<a:cargando2:858715584691044402> **Generando un token de Twitch...**}{color:#ffff00}{footer: Desarrollado por AdirModz👑#6666
}{delete:4s};no]
