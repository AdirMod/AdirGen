...
$onlyIf[$channelExists[$findChannel[$message]]!=false;{color:RED}{footer: Desarrollado por AdirModz👑#6666
}{description: $getVar[bademoji] **Hey $username, el canal que indicastes no existe.**}]
...
}{description: $getVar[bademoji] **Hey $username, debes tener el permiso de configurar canales para poder usar eso.**}]
